...
const dumb = [" You can do this by picking the first row of boxes", " Split the first row of boxes of as evenly as possible", " Split the arrays even further", " Select the other ones and split them", " Split them as evenly as possible", " The wheel is spinning but the hamster's dead", " Bruh", " You are just bring silly now.", " Stop monkeying around to see if it works."]
